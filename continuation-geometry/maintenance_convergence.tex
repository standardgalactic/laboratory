...
Supervisory tasks involve monitoring the operation of automated
workflows---a residual category of labor in its own right
\cite{zuboff1988}.  Maintenance tasks consist of repairing errors, cleaning
outputs, correcting
...
generative component of labor, formalizing the collapse of generative labor
under technological substitution \cite{frey2017} and the consequent
redistribution of occupational tasks \cite{acemoglu2019}.
...
of occupational composition, extending prior treatments of automation
thresholds as occupational phase transitions \cite{autor2015}.
...
Industrial kitchens replaced individual culinary expertise with assembly lines \cite{ritzer1993}.
...
edge cases that automated systems could not handle \cite{autor2015}.
...
maintenance dominates the long-run equilibrium \cite{ritzer1993,autor2015}.
...
maintenance, and the correction of artifacts produced by automated systems, a
shift already documented as debugging becomes the dominant mode of software
production \cite{lientz1980,gray2019}.
\end{corollary}
...
of automated construction and generative design processes \cite{bock2015}.
\end{corollary}
...
Let $C$ denote a measure of technological system complexity, in the sense of
a balance between functional segregation and integration proposed for
biological neural systems \cite{tononi1994}.  The model
...
all exchanges between them \cite{friston2019}.  A cell membrane performs an analogous function:
it does not generate the metabolic activity of the cell, but regulates and
maintains the conditions under which that activity can occur, in the manner
of homeostatic regulation described for physiological systems generally
\cite{cannon1932,ashby1952}.  The membrane
...
maintenance, echoing earlier accounts of workers repositioned toward
monitoring and correcting automated processes rather than generating them
directly \cite{zuboff1988}.  This tendency is not incidental but follows necessarily from the
...
a hidden infrastructural function documented across advanced economies
\cite{star1999}.
...
film \emph{Perfect Days} (2023), directed by Wim Wenders \cite{wenders2023}.  The film follows
...
of daily life that is internally coherent, reproducible, and meaningful, in
a manner consonant with accounts of optimal, self-rewarding engagement with
a task \cite{csikszentmihalyi1990}.  Hirayama does not aspire to escape the custodial role; he inhabits it with
...
navigated with care, echoing arguments that skilled, attentive maintenance
work carries its own dignity and craft \cite{sennett2008,crawford2009}.
...
networks, and personal digital devices, an ordinary phenomenology of repair
and upkeep that has itself become an object of scholarly attention
\cite{graham2007}.  These activities correspond almost
...
machines perform labor while humans pursue creative or intellectual ends,
a speculation with a long lineage stretching back to early forecasts of a
leisure economy freed from want \cite{keynes1930}.  The
...
increasingly complex technological systems, a redistribution of employment
toward custodial functions rather than its disappearance \cite{susskind2020}.  The progressive vision in which
...
and accumulation of errors and physical debris \cite{georgescuroegen1971}.  Let $E$ denote the
...
economic activity \cite{georgescuroegen1971}; the second law of thermodynamics guarantees that this role
is never eliminated.
...
$T^*$ exponentially at rates $e^{-\alpha t}$ and $e^{-\gamma t}$, consistent
with the general principle that repair and recovery restore stability in
industrial networks \cite{graham2007}.
\end{proposition}
...
\textit{American Behavioral Scientist}, 43(3), 377--391.
...
\textit{Journal of Economic Perspectives}, 33(2), 3--30.
...
\bibitem{ritzer1993}
Ritzer, G. (1993).
\textit{The McDonaldization of Society}.
Pine Forge Press.

\bibitem{lientz1980}
Lientz, B.~P., \& Swanson, E.~B. (1980).
\textit{Software Maintenance Management: A Study of the Maintenance of Computer
Application Software in 487 Data Processing Organizations}.
Addison-Wesley.

\bibitem{gray2019}
Gray, M.~L., \& Suri, S. (2019).
\textit{Ghost Work: How to Stop Silicon Valley from Building a New Global
Underclass}.
...
\textit{Automation in Construction}, 59, 113--121.

\bibitem{susskind2020}
Susskind, D. (2020).
\textit{A World Without Work: Technology, Automation, and How We Should
Respond}.
Metropolitan Books.
...
In \textit{Essays in Persuasion} (1931).
Macmillan.
