...
Suppose a user produces some statement $x$, and personas $P_1, \ldots, P_n$ return judgments $J_1(x), \ldots, J_n(x)$. The apparent strength of consensus is tempting to associate with $n$. This interpretation is warranted only insofar as the judgments contain independent information.
