...
A minimal architecture realizing scoped refusal requires an explicit codomain for the decision that converts history into consequence, rather than leaving refusal as constitutional prose with no corresponding object, in the spirit of the decentralized authorization architectures developed for exactly this purpose \cite{blaze1996,ellison1999,rivest1996}. For a candidate use $e$, history $H$, context $\kappa$, applicable policy $\pi$, and available authorization evidence $z$,
\[
