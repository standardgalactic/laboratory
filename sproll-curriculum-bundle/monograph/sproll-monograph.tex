...
\textbf{Abstract}
\end{center}
\noindent This monograph documents the design, formal foundations, and complete forty-booklet plan of the Sproll Curriculum, a children's mathematics curriculum built directly on the four primitive operations of the Spherepop calculus (Pop, Refuse, Bind, Collapse) and on the epistemic operator distinction (U, Q, P, A) developed in \emph{Beyond Prediction Error: Warrant, Repair, and Refusal in Predictive Architectures}. The central claim is architectural rather than merely pedagogical: a curriculum can embody a formal theory in its construction order rather than merely illustrating the theory afterward, so that a child's progression through the booklets reproduces, at each stage, exactly the operations the underlying calculus admits at that stage and no others. The curriculum is published in two parallel tracks at every stage of the sequence, a Primary Track and a Workbook Track, discussed in Chapter 3; both follow the identical forty-topic order and differ only in depth and reading level, never in content or sequencing. Part I states the methodology, the three-layer architecture (historical construction, ordinary mathematics, epistemic transformation), and the two-track publication model that keeps this embodiment principled rather than decorative. Part II gives the formal mathematics underlying the curriculum, including a proof that reweighting cannot instantiate refusal and a precise statement of the three-way distinction between zero-weighting, documented inadmissibility, and constitutive domain revision. Part III specifies the Sproll house style as a reproducible format, with reference implementations from the Primary Track annotated line by line against the formalism they encode. Part IV gives the complete, renumbered forty-booklet plan across seven cycles, applicable to both tracks identically. Part V discusses what was learned from several rounds of correcting the curriculum's own vocabulary and scope against moving specifications, and treats that correction history itself as an instance of the monotonic-continuation principle the curriculum teaches.
\vspace{1em}
...
This principle is orthogonal to reading level, which is why the curriculum is published in two tracks rather than one. A reader not yet ready for extended prose still needs the same ordering respected; a reader ready for worked examples and written exercises needs it respected too. Depth of exposition is a separate axis from the ordering constraint, so the two tracks share every topic, every sequence position, and every formal dependency, and differ only in how much is said about each one.

This monograph exists to make that claim checkable rather than merely asserted. Part II proves the central formal results the curriculum depends on. Part III shows, booklet by booklet, exactly which formal move each page encodes. Part IV extends this discipline to all forty booklets before most of them are drafted, so that later drafting, in either track, is a matter of executing a specification rather than improvising one.
...
\section{Two Tracks, One Sequence}

The curriculum is published twice at every point in the forty-topic sequence: once as a Primary Track booklet and once as a Workbook Track booklet. The two tracks are not different curricula that happen to cover similar ground; they are two depths of the same specification. A Primary Track booklet enacts its topic's operator in as few pages as the topic allows, with minimal or no exposition, relying on illustration and repetition rather than explanation. A Workbook Track booklet enacts the same operator, in the same position in the same sequence, but adds worked examples, everyday grounding analogies, boxed procedures, and written exercises, addressed directly to a reader capable of following extended prose. Neither track states a target age anywhere on the page; the tracks are distinguished by depth, not by an announced reading level.

Because both tracks answer to the same Part IV specification, a claim proven or flagged against one track's booklet applies to the other track's booklet at the same sequence position by construction, unless a track-specific note says otherwise. Part III's annotations, drawn from the Primary Track, are read this way: a Workbook Track booklet at the same number is expected to satisfy the same formal correspondences, stated at greater length.

\section{Constraints, Not Preferences}

Every formatting choice in the Sproll house style is stated as a constraint that the first booklets in each track satisfy and that later booklets in that track inherit, rather than as a stylistic preference chosen once and then applied loosely. The constraints below were established by the Primary Track's Sprolls 00 and 01 and refined across two correction passes; the Workbook Track satisfies constraints 1 through 4 in the same form, with constraint 5 (backmatter addressed to an adult reader) supplemented in the Workbook Track by exposition addressed directly to the child reader, since a Workbook Track reader is assumed able to receive some of that content firsthand rather than only through a parent or teacher.
...
Part III checks Part II's formalism against the Primary Track booklets drafted so far, page by page. Three purposes are served simultaneously. First, this is the discipline the remaining Primary Track booklets must satisfy before being considered complete, so the annotation format established here is itself part of the specification. Second, checking the formalism against real pages surfaces gaps in Part II that abstract review did not: two are found below and neither is cosmetic. Third, by Chapter 3's two-track principle, every correspondence and every gap identified here against a Primary Track booklet applies equally to the Workbook Track booklet at the same sequence position; the Workbook Track editions of Sprolls 00 through 03 are not separately annotated in this Part, since they encode the identical operator content at greater length rather than different content, but a future revision of this Part should add Workbook-Track-specific page references alongside the Primary Track ones given here, particularly where a Workbook Track booklet's added worked examples introduce their own real-world groundings not present in the Primary Track edition.
